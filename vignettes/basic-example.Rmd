---
title: "Basic example of history matching with emulation workflow"
...
We'll use the simple susceptible-infected-removed model used in the `{hmer}` package examples.

Our package used tidy models for inspiration [](https://www.tmwr.org/workflows.html).
